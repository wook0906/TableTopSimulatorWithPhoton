...
public class CameraController : MonoBehaviourPunCallbacks
{
	...
	public GameObject curTargetingObj;
	...
	private void Start()
	{
		...
		//Managers.Input.mouseAimAction -= OnAimJoystick;
		//Managers.Input.mouseAimAction += OnAimJoystick;
    ...
    void IsTargetLockOn()
    {
        ...
        RaycastHit hit;
		DraggableObject draggable = null;
		...
		{
			curTargetingObj = hit.transform.gameObject;
			draggable = curTargetingObj.GetComponent<DraggableObject>();
			draggable.SetCamera(player.cam);
		}
		else
		{
			curTargetingObj = null;
		}
    }
}